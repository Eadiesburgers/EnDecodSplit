...
Function fcnHelper
	...
	vbcrlf & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & "--> Example: " & WScript.ScriptName & " E " & chr(34) & "c:\bobs folder\mail files\Big File.pdf" & chr(34) & " " & chr(34)& "c:\temp\my destination folder\Email Attachments"  & chr(34) & " 9000 10000" & vbcrlf & "<" & lineVar
End Function
